...
if (key == 65) {
 ...
 if (key == 74) {
	...
	audio.currentTime = 0;
	audio.play();
	document.getElementById('74').style.backgroundColor = "#39FF14";
	document.getElementById('74').style.boxShadow ="0px 0px 20px 0px #39FF14";
	setTimeout(function() {
 ...
 if (key == 75) {
	...
	audio.currentTime = 0;
	audio.play();
	document.getElementById('75').style.backgroundColor = "#39FF14";
	document.getElementById('75').style.boxShadow ="0px 0px 20px 0px #39FF14";
	setTimeout(function() {
 ...
 if (key == 76) {
	...
	audio.currentTime = 0;
	audio.play();
	document.getElementById('76').style.backgroundColor = "#39FF14";
	document.getElementById('76').style.boxShadow ="0px 0px 20px 0px #39FF14";
	setTimeout(function() {
